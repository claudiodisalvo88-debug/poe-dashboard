...
Next action:
`M-002-RQ-031-DOCUMENT-RESEARCH-FRAMING` must document `RQ-031` as research-framing only under the PM-refined conceptual co-discussion / co-presence boundary, without answering `RQ-031`, without validating `RQ-031`, without closing `RQ-031`, without creating `PD-031`, without defining formula candidate or implementation.
