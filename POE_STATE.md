...
Next action:
`M-002-ROUTE-AFTER-FORMULA-CANDIDATE-RESEARCH-ENTRY-BOUNDARY-RECHECK-REVIEW` must route the next research-only step after formula-candidate research entry-boundary recheck, without opening, authorizing, approving, naming, drafting or defining any formula candidate.
