...
Next action:
`M-002-ROUTE-AFTER-FORMULA-CANDIDATE-RESEARCH-OPENING-CONSIDERATION-BOUNDARY-REVIEW` must route the next research-only step after formula-candidate research opening-consideration boundary review, without opening, naming, drafting or defining any formula candidate.
